...
public class Lancamento {
	...
	@SequenceGenerator(name="lancamento_id", sequenceName="lancamento_id")
	private Long id;
	...
	@NotNull(message = "O tipo do lancamento não pode ser nulo")
	private TipoLancamento tipo;

	@NotNull(message = "O lançamento deve está associado a uma categoria")
	@ManyToOne
	@JoinColumn(name = "id_categoria")
	private Categoria categoria;

	@NotNull(message = "O lançamento deve está associado a uma Pessoa")
	@ManyToOne
